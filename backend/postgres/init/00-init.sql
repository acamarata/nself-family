...
SELECT 'CREATE DATABASE "nself_family_dev"'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'nself_family_dev')\gexec

-- Grant all privileges
GRANT ALL PRIVILEGES ON DATABASE "nself_family_dev" TO postgres;
